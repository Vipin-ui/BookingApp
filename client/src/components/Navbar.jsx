...
//           >
//          { isOwner ? ' Dashboard' : 'List Your Hotal'}
//         </button>
//   )
// }
//       </div>
...
//             onClick={openSignIn}
//             className={
//               " bg-black text-white px-8 py-2.5 rounded-full ml-4 transition-all duration-500 "
//             }
//           >
//             Login
//           </button>
      ...
      >
        ...
        {user && (
          <button
            ...
            {isOwner ? 'Dashboard' : 'List Your Hotwl'}
          </button>
        )}
